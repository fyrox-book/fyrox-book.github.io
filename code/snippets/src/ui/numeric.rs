...
use fyrox::{
    core::pool::Handle,
    gui::{numeric::NumericUpDownBuilder, widget::WidgetBuilder, BuildContext},
};
...
fn create_numeric_widget_with_limits(ctx: &mut BuildContext) -> Handle<NumericUpDown<f32>> {
    NumericUpDownBuilder::new(WidgetBuilder::new())
        .with_value(123.0f32)
        .with_min_value(42.0)
...
fn create_numeric_widget_with_step(ctx: &mut BuildContext) -> Handle<NumericUpDown<f32>> {
    NumericUpDownBuilder::new(WidgetBuilder::new())
        .with_value(125.0f32)
        .with_step(5.0)
        .build(ctx)
...
fn create_numeric_widget_with_precision(ctx: &mut BuildContext) -> Handle<NumericUpDown<f32>> {
    NumericUpDownBuilder::new(WidgetBuilder::new())
