...
to the left are ordered in alphabetical order. However, below we will order them by primary function to help introduce 
them to new users.
...
* [Dropdown Menu](./dropdown_menu.md) - **TODO**
* [Selector](./selector.md) - **TODO**
* [Navigation](./navigation.md) - **TODO**
...
* [Progress Bar](./progress_bar.md): The Progress Bar shows a bar whose fill state can be adjusted to indicate visually how full 
...
for each type.
* [Thumb](./thumb.md) - **TODO**
* [Key Binding](./key_binding.md) - **TODO**
* [Toggle Button](./toggle_button.md) - **TODO**

## Full List

The book describes only those widgets that are usable in game development, the full number of widgets in the 
engine is more than 115. The list above describes nearly one third of the total number. See implementors of
`Control` [trait in the API docs](https://docs.rs/fyrox/latest/fyrox/gui/trait.Control.html), keep in mind
that some of the widgets are available only in the editor, which means that they can be used to write editor
plugins.