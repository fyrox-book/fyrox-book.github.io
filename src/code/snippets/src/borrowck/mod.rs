...
impl ScriptTrait for MyScript {
    fn on_update(&mut self, ctx: &mut ScriptContext) {
        ...
        let mut some_other_node_ref = mbc.try_get_mut(self.some_other_node).unwrap();
        let mut yet_another_node_ref = mbc.try_get_mut(self.yet_another_node).unwrap();
...
impl ScriptTrait for Bot {
    fn on_update(&mut self, ctx: &mut ScriptContext) {
        ...
        let mut this = mbc.get_mut(ctx.handle);
